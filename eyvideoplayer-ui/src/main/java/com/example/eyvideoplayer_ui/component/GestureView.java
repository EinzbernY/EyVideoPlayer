package com.example.eyvideoplayer_ui.component;
...
import com.example.eyvideoplayer_ui.R;
import com.example.eyvideoplayer_java.controller.IGestureComponent;
import com.example.eyvideoplayer_java.controller.ControlWrapper;
import com.example.eyvideoplayer_java.player.VideoView;

import static com.example.eyvideoplayer_java.util.PlayerUtils.stringForTime;
...
public class GestureView extends FrameLayout implements IGestureComponent {
    ...
    {
        setVisibility(GONE);
        LayoutInflater.from(getContext()).inflate(R.layout.eyplayer_layout_gesture_control_view, this, true);
    ...
    public void onPositionChange(int slidePosition, int currentPosition, int duration) {
        ...
        if (slidePosition > currentPosition) {
            mIcon.setImageResource(R.drawable.eyplayer_ic_action_fast_forward);
        } else {
            mIcon.setImageResource(R.drawable.eyplayer_ic_action_fast_rewind);
        }
    ...
    public void onBrightnessChange(int percent) {
        ...
        mIcon.setImageResource(R.drawable.eyplayer_ic_action_brightness);
    ...
    public void onVolumeChange(int percent) {
        ...
        mProgressPercent.setVisibility(VISIBLE);
        if (percent <= 0) {
            mIcon.setImageResource(R.drawable.eyplayer_ic_action_volume_off);
        } else {
            mIcon.setImageResource(R.drawable.eyplayer_ic_action_volume_up);
        }
        mTextPercent.setText(percent + "%");
        mProgressPercent.setProgress(percent);
    }
