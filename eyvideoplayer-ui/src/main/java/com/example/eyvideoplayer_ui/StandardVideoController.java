package com.example.eyvideoplayer_ui;
...
import com.example.eyvideoplayer_ui.component.CompleteView;
import com.example.eyvideoplayer_ui.component.ErrorView;
import com.example.eyvideoplayer_ui.component.GestureView;
import com.example.eyvideoplayer_ui.component.LiveControlView;
import com.example.eyvideoplayer_ui.component.PrepareView;
import com.example.eyvideoplayer_ui.component.TitleView;
import com.example.eyvideoplayer_ui.component.VodControlView;
import com.example.eyvideoplayer_java.controller.GestureVideoController;
...
public class StandardVideoController extends GestureVideoController implements View.OnClickListener {
    ...
    protected int getLayoutId() {
        return R.layout.eyplayer_layout_standard_controller;
    }
    ...
    protected void onLockStateChanged(boolean isLocked) {
        if (isLocked) {
            ...
            Toast.makeText(getContext(), R.string.eyplayer_locked, Toast.LENGTH_SHORT).show();
        } else {
            mLockButton.setSelected(false);
            Toast.makeText(getContext(), R.string.eyplayer_unlocked, Toast.LENGTH_SHORT).show();
        }
    }
    ...
    public boolean onBackPressed() {
        if (isLocked()) {
            show();
            Toast.makeText(getContext(), R.string.eyplayer_lock_tip, Toast.LENGTH_SHORT).show();
            return true;
        }
        if (mControlWrapper.isFullScreen()) {
